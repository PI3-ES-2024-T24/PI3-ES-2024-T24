 ...
 * Use the [MenuManagerFragment.newInstance] factory method to
...
class MenuManagerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_menu_manager, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MenuManagerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MenuManagerFragment().apply {
